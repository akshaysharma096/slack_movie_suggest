"""
Django settings for popcorntime_slack project.
...
ROOT_URLCONF = 'slack_movie_suggest.urls'
...
WSGI_APPLICATION = 'slack_movie_suggest.wsgi.application'
...
FACEBOOK_WEBHOOK_TOKEN = os.environ['FACEBOOK_WEBHOOK_TOKEN']
